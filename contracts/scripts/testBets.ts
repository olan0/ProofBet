...
async function main() {
    ...
    const proofToken = await ethers.getContractAt("ProofToken", "0x610178dA211FEF7D417bC0e6FeD39F05609AD788");
    const trustScore = await ethers.getContractAt("TrustScore", "0xB7f8BC63BbcaD18155201308C8f3540b07f84F5e");
    const factory = await ethers.getContractAt("BetFactory", "0x0DCd1Bf9A1b36cE34237eEaFef220932846BCD82");
    const usdcToken = await ethers.getContractAt("MockERC20", "0x8A791620dd6260079BF849Dc5567aDC3F2FdC318");
