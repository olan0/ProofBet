...
async function main() {
    ...
    const factory = await ethers.getContractAt("BetFactory", "0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9");
    const usdcToken = await ethers.getContractAt("MockERC20", "0x5FbDB2315678afecb367f032d93F642f64180aa3");
      ...
      console.log("  ✅ Accounts prepared.");
       ...
       // Include the new 'keeper' account for funding
        ...
        for (const acc of accountsToFund) {
            ...
            console.log(`  - Funding ${addr.substring(0,10)}...`);
